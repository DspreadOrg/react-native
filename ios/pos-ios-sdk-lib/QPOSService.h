...
- (void)setAppSelectOption:(BOOL)isEnable;
- (void)selectEmvAppCancel;
- (NSInteger)getSelectAppTimeout;
- (void)setRecallTrade:(BOOL)recall;
- (void)setSelectAppTimeout:(NSInteger)timeout;
- (void)setBuzzer:(BOOL)status times:(NSInteger)times resultBlock:(void(^)(BOOL isSuccess))resultBlock;
